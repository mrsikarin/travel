                ...
                <table id="example" class="table table-hover" style="width:100%" border="0.1">
                    ...
                    <tbody>
                        <?php while ($idtype = mysqli_fetch_array($mysql)) { ?>
                            ...
                            ?>
                            <tr>
                                <td><img src="<?php echo $idtype[3]; ?>" style="width:100px;height:100px;"></td>
                                <td style="width:20%"> <h3><?php echo $idtype[1]; ?> </h3></td>
                                <td> <?php echo $idtype[2]; ?> </td>
                                <td> <?php echo $typename[1]; ?> </td>
                                <td> <?php echo $idtype[5]; ?> </td>
                                <td> <a href="editpage.php?id=<?php echo $idtype[0]; ?>"><input class="btn btn-warning" type="button" value="แก้ไข"></a>
                                    <a href="del.php?id=<?php echo $idtype[0]; ?>"><input class="btn btn-danger" type="button" value="ลบ"></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
